...
@onready var beginner_dungeon_button: Button = find_child("BeginnerDungeonButton")
@onready var medium_dungeon_button: Button = find_child("MediumDungeonButton")
...
func _ready() -> void:
	...
	beginner_dungeon_button.pressed.connect(_on_b_dungeon_button_pressed)
	medium_dungeon_button.pressed.connect(_on_m_dungeon_button_pressed)
